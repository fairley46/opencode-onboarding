...
- you do not need to be technical to use this well
...
You are still accountable for decisions, approvals, and anything business-critical. The point of this onboarding is to help you use AI with more clarity, not less.

## What To Remember

You are allowed to ask basic questions here. Confusion is normal. We are building a safe mental model first so the hands-on steps make sense later.
